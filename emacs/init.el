...
(custom-set-variables
 ...
 '(package-selected-packages
   '(writeroom-mode peep-dired dired-hide-dotfiles dired-open all-the-icons-dired dired-single neotree eshell-git-prompt vterm rainbow-delimiters evil-nerd-commenter forge magit counsel-projectile projectile yasnippet-snippets yasnippet company-box company rustic cargo cmake-project cmake-font-lock cmake-mode modern-cpp-font-lock eldoc-box pyvenv typescript-mode dap-mode lsp-ivy lsp-treemacs lsp-ui lsp-mode visual-fill-column org-bullets which-key use-package no-littering minimap ivy-rich ivy-prescient ivy-posframe hydra helpful general evil-collection emojify doom-themes doom-modeline dashboard counsel clippy auto-package-update all-the-icons)))
(custom-set-faces
